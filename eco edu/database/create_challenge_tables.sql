-- Create Challenge Tables for EcoEdu Database
...
SELECT COUNT(*) as 'Categories Created' FROM challenge_categories;
SELECT COUNT(*) as 'Challenges Created' FROM eco_challenges;
SELECT COUNT(*) as 'Rewards Created' FROM eco_rewards;
